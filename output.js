//Sat Jun 29 2024 17:01:45 GMT+0000 (Coordinated Universal Time)
...
class _0x4c27a8 {
  ...
  async taskApi(_0x3967b8 = {}) {
    ...
    try {
        ...
        if (typeof _0x3967b8.body === "object") {
          if (_0x35520c.headers["Content-Type"].includes("json")) {
            ...
            for (let _0x35ecf0 in _0x3967b8.body) {
              if (typeof _0x3967b8.body[_0x35ecf0] === "object") {
                _0x3967b8.body[_0x35ecf0] = JSON.stringify(_0x3967b8.body[_0x35ecf0]);
              }
            }
      ...
      if (_0x4dd0e8.statusCode != 200) {
        console.log("[" + _0x3967b8.fn + "]返回[" + _0x4dd0e8.statusCode + "]");
      }
...
function _0x5783c6() {
  ...
  console.log("=======By夜神月，投稿项目联系QQ412323002=======");
  ...
  try {
    ...
    if (_0x457fa9.err) {
      ...
      try {
        ...
        if (_0x239829?.["code"] == 0) {
          _0x239829 = JSON.parse(_0x239829.data.file.data);
        }
      } catch (_0x5d759c) {}
    }
    if (!_0x239829) {
      ...
      if (_0x239829?.["commonNotify"] && _0x239829.commonNotify.length > 0) {
        _0x8716db.logAndNotify(_0x239829.commonNotify.join("\n") + "\n");
      }
      if (_0x239829?.["commonMsg"] && _0x239829.commonMsg.length > 0) {
        console.log(_0x239829.commonMsg.join("\n") + "\n");
      }
...
function _0x4cda8f(_0x1e4724, _0xff6f77) {
  ...
  return new class {
      ...
      if (/^@/.test(_0x4fefce)) {
        ...
        if (_0x31bfd6) {
          try {
            ...
            _0x479c6a ? _0x3782e9 = this.lodash_get(_0x479c6a, _0x48c0c3, "") : _0x3782e9 = _0x3782e9;
          } catch (_0x4facad) {
            _0x3782e9 = "";
          }
        }
      ...
      if (this.isSurge() || this.isLoon()) {
        ...
        if (this.isQuanX()) {
          ...
          if (this.isNeedRewrite) {
            _0x46cad7.opts = _0x46cad7.opts || {};
            Object.assign(_0x46cad7.opts, _0x327740);
          }
    ...
    time(_0x2ef619, _0x16db29 = null) {
      ...
      if (/(y+)/.test(_0x2ef619)) {
        _0x2ef619 = _0x2ef619.replace(RegExp.$1, (_0x2c3750.getFullYear() + "").substr(4 - RegExp.$1.length));
      }
      for (let _0x4ccae2 in _0x5cd64f) if (new RegExp("(" + _0x4ccae2 + ")").test(_0x2ef619)) {
        _0x2ef619 = _0x2ef619.replace(RegExp.$1, 1 == RegExp.$1.length ? _0x5cd64f[_0x4ccae2] : ("00" + _0x5cd64f[_0x4ccae2]).substr(("" + _0x5cd64f[_0x4ccae2]).length));
      }
      return _0x2ef619;
    }
    async showmsg() {
    ...
    msg(_0x281b91 = t, _0x2a5e45 = "", _0x441be7 = "", _0xd75caf) {
      ...
      if (_0x2a5e45) {
        _0x3eabf5.push(_0x2a5e45);
      }
      if (_0x441be7) {
        _0x3eabf5.push(_0x441be7);
      }
